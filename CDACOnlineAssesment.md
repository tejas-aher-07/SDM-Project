...
## Title:
System Reqruiement Spefication for Online Assesment for CDAC courses.
...
## Objective (Purpose):
A Web Application for the online assesment System for CDAC Courses is intended to  provide complete online platform for conducting the Exam for various CDAC courses for next upcoming batches. It fully automates all the previous manual process of taking written exam. It saves time as it allows number of students to give the exam at same time.It allows assessments to be evaluated in less time.
...
### Security
Registered Student will allowed to appear for the examination.	
Each Student will be able to access the examination questions on their login page through authentication process. Please Enter Form No and Password ?
